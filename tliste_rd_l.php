...
class rd_l {
	...
	function draw($iNo, &$tli, $maxcar = 0) 
	{
         ...
         */
	        ...
	        $s   =  "<img  src=\"". $tli->imagePath . $xx . "n.gif\" width=\"18\" align=\"top\" border=\"0\">" .$s ;
				...
				if ($this->sURL === "") 
				{
       	  $s = $s . "<span class=\"". $tli->style ."\">".$this->sDesc."</span>" ;
				}
				else
				{
        	$s = $s."<a href=\""  ;
          ...
          if ($maxcar > 0) {
          	$_ss = mb_strimwidth($this->sDesc, 0, ($maxcar-($this->iN * 2 )), "..." ) ;
          	$s = $s . " class=\"" . $tli->style . "\"><span title=\"".$this->sDesc ."\">" . $_ss . "</span></a>" ;
          } else {
          	$s = $s . " class=\"" . $tli->style . "\">" . $this->sDesc . "</a>" ;
          }
        }
